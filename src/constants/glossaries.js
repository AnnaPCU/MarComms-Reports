...
export const GLOSSARIES = {
  ...
  webinars: {
    ...
    entries: [
      ...
      { term: 'Deal (HubSpot)', def: 'Oportunidad comercial creada en HubSpot por cada asistente externo del webinar. Los asistentes internos (Control Union / Peterson) no generan deals.' },
  ...
  webinarsEn: {
    ...
    entries: [
      ...
      { term: 'Deal (HubSpot)', def: 'Business opportunity created in HubSpot for each external webinar attendee. Internal attendees (Control Union / Peterson) do not generate deals.' },
